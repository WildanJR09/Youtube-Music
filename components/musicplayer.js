...
export default function Musicplayer() {
    ...
    return (
        <>
            ...
            <nav className="fixed bottom-0 w-full bg-[#624F82] space-y-2 border-t-[#352b46] border-t-4">
                ...
                <div className='flex items-center flex-row w-full md:justify-between gap-5 py-4 px-4 md:px-7 h-16'>
                    ...
                    <div className='hidden md:flex gap-7 md:gap-10 text-2xl text-gray-200/80'>
                        <button onMouseOver={showVolumeInput} onMouseOut={HideVolumeInput} className=''>
                            <div onMouseOver={showVolumeInput} onMouseOut={HideVolumeInput} id='inputVolume' className='bg-[#5d4c7a] items-center gap-x-4 text-sm rounded px-7 py-5 pr-16 hidden absolute right-[160px] bottom-0'>
                                <p>{currentVolume}</p>
